...
/*where to actually use goroutine in order to make the execution parallel, what is it's applications*/
/*same as the asynchronous execution in JavaScript/TypeScript*/
